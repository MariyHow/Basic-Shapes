...
public:
	...
	void PrintInfo() { cout << make << " " << year << " " << mileage << " " << endl; }
};
...
public:
	...
	void PrintInfo() { cout << make << " " << year << " " << mileage << " " << price << " " << capacity << " " << endl; }
};
...
public:
	...
	void PrintInfo() { cout << make << " " << year << " " << mileage << " " << price << " " << driveType << " " << wheelSize << " " << endl; }
